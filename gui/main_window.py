...
class MainWindow(QMainWindow):
    ...
    def open_video(self):
        ...
        self.all_pages.heart_rate_variability_page.path_label.setText(
            "Выбран файл " + filename.split("/")[-1].split(".")[0])
    ...
    def setPositionHRV(self, position):
        self.all_pages.heart_rate_variability_page.videoLabel.setPixmap(
            QPixmap.fromImage(process_img(self.current_video[position])))
    ...
    def recall_thread_data(self):
        ...
        self.all_pages.video_capture_page.videoLabel.setPixmap(
            QPixmap.fromImage(self.all_pages.video_capture_page.placeholder))
    ...
    def tune_video_widgets(self):
        ...
        self.all_pages.heart_rate_variability_page.videoLabel.setPixmap(
            QPixmap.fromImage(process_img(self.current_video[0])))
